...
const VerifyEmailPage = () => {
  ...
  useEffect(() => {
    if (!email) {
      Alert.alert('Error', 'Missing email address. Please sign up again.');
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      Alert.alert('Success', response.message || 'Email verified successfully! You can now log in.');
      navigation.navigate('Login');
    } catch (error) {
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      Alert.alert('Success', 'A new verification OTP has been sent to your email.');
    } catch (error) {
